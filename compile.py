...
file_to_compile = input("Enter file to compile\n")
#
libraries_to_link = []  # add any required libraries here
# any cpp/c libraries in your project that you need compiled and linked
libraries_that_need_compiling = []
    ...
    while True:
        ...
        if user_input == "chfile":
            ...
            try:
                ...
                execute(compiler + " " + file_to_compile + astring + libstring)
